...
DISTANCE_SCALE_PARAMETER = 250
TRANSMIT_POWER_DB = 0  # 43 – 48 dBm typical LTE transmit power values

TIME_ADVANCE = 1e-6  # in time unit
PACKETS_TARGET = 300000  # number of packets to simulate
MAX_SCHEDULING_BLOCKS = 50
AVERAGE_REQUIRED_RESOURCE_BLOCKS = MAX_SCHEDULING_BLOCKS/2

LAMBDA_SIMULATION_RANGE = [1] + list(range(200, 6001, 200)) + list(range(6100, 10000, 100)) + list(range(10100, 11601, 50))
...
OUTPUT_FILE_NAME = QUEUING_SYSTEM.value + '-' + FADING.value + 'height' + str(HEIGHT) + '.csv'
