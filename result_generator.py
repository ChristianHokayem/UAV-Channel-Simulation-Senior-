...
OUTPUT_FILE_NAME = 'mod_priority_low.csv'
...
for LAMBDA in [1] + list(range(5, 401, 5)):
  print()
  ...
  run_sim(LAMBDA, MU, MODIFIED_PRIORITY_QUEUING)
  ...
  print("-" * 15)
  print("Average low priority wait time:", average_low_priority_wait_time)
  print("Average high priority wait time:", average_high_priority_wait_time)
  print("Average total wait time:", average_total_wait_time)
