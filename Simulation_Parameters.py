...
PACKET_QCI_DICT = {1: PacketQCI(1, True, 2, 0.1, proportional_lambda=0.2, description="Conversational Voice"),
                   2: PacketQCI(2, True, 4, 0.150, proportional_lambda=0.1, description="Conversational Video"),
                   3: PacketQCI(3, True, 5, 0.300, proportional_lambda=0.1, description="Live streaming"),
                   ...
                   6: PacketQCI(6, False, 7, 0.100, proportional_lambda=0.1, description="Voice, video, gaming"),
                   7: PacketQCI(7, False, 6, 0.300, proportional_lambda=0.1, description="Video (Buffered Streaming)"),
                   8: PacketQCI(8, False, 6, 0.300, proportional_lambda=0.1, description="TCP Based High Priority"),
                   9: PacketQCI(9, False, 6, 0.300, proportional_lambda=0.1, description="TCP Based Low Priority")}

if round(sum(PACKET_QCI_DICT[i].proportional_lambda for i in PACKET_QCI_DICT), 3) != 1:
  raise ValueError("Proportional arrival rates exceed 1.0")
